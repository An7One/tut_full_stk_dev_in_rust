...
fn process_head_line(s: &str) -> (String, String) {
...
mod test {
    ...
    fn test_read_http(){
        ...
        let headers_expected: HashMap<String, String> = {
            ...
            map.insert("Accept".into(), " */*".into());
            map.insert("User-Agent".into(), " curl/7.71.1".into());
            map
        };
        let req: HttpRequest = s.into();
        assert_eq!(Method::Get, req.method);
        assert_eq!(Version::V1_1, req.version);
        assert_eq!(Resource::Path("/greeting".to_owned()), req.resource);
